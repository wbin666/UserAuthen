        ...
        .directive('ngAutodisable', [ '$parse', function($parse) {
            ...
            function linkFn(scope, element, attrs) {
                ...
                if (attrs.hasOwnProperty(CLICK_ATTR)) {
                    ...
                    //handler = handlerInstance(element.find('input[type=submit]'),     // change to input[type=submit]
                    var submitBtnElement = element.find('#'+ attrs.acdsubmitbtnid);     // find the elementToDisable by id
                    handler = handlerInstance(submitBtnElement,
                        SUBMIT_EVENT,
                        getLoadingClass(attrs),
